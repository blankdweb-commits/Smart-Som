...
async def verify():
    async with async_playwright() as p:
        ...
        await page.fill("input[placeholder*='Ask about medications']", "episiotomy")
        await page.click("button:has-text('Research')")

        # Wait for results
        await page.wait_for_selector("text=Episiotomy Care & Indications", timeout=10000)
        print("Search Assistant returned correct result for 'episiotomy'")
