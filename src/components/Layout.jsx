  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      ...
      <main className="flex-1 overflow-auto mb-16 lg:mb-0">
        {/* Mobile Header - Logo only, no menu toggle */}
        <header className="lg:hidden sticky top-0 z-20 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 p-4 flex items-center">
