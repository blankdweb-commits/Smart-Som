  ...
  return (
    <div className="space-y-6 pb-20">
      <header>
        ...
        {isExamSoon && (
          <div className="mt-4 p-4 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 rounded-r-xl flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-red-700 dark:text-red-400 text-sm font-medium">
                  Your <strong>{immediateExam.title}</strong> exam is soon ({new Date(immediateExam.date).toLocaleDateString()}).
                </p>
              </div>
            </div>
