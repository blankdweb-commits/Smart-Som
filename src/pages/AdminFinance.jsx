              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="p-8 bg-slate-50 dark:bg-slate-900/50 rounded-[2rem] border border-slate-100 dark:border-slate-800 space-y-6">
                    ...
                    <div className="space-y-4">
                       ...
                       <button onClick={() => alert('Transaction Logged & Processed: +NGN Audit Entry Created.')} className="w-full py-4 bg-medical-600 text-white rounded-xl font-black uppercase tracking-widest text-xs shadow-lg active:scale-95 transition-all">Authorize Credit</button>
                    </div>
                 </div>

                 <div className="space-y-4">
                    <h4 className="font-black uppercase text-sm px-2">Audit trail (Pending)</h4>
                    {[1, 2].map(i => (
                       <div key={i} className="p-4 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 flex justify-between items-center">
                          <div className="flex items-center gap-3">
                             ...
                             <div>
                                ...
                                <p className="text-[10px] text-slate-400">Admin #{1000 + i}</p>
                             </div>
                          </div>
                          <p className="font-black text-sm text-emerald-600">+₦{i * 5000}</p>
                       </div>
                    ))}
                 </div>
              </div>
