      ...
      <motion.div key={currentQuestionIndex} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="px-4">
        <div className="bg-white dark:bg-slate-800 p-8 sm:p-12 rounded-[3rem] border border-slate-100 dark:border-slate-700 shadow-clinical relative overflow-hidden">
           ...
           <div className="relative z-10">
              <span className="inline-block px-4 py-1.5 bg-medical-50 dark:bg-medical-900/30 text-medical-600 dark:text-medical-400 rounded-xl text-[10px] font-black uppercase tracking-widest mb-6 border border-medical-100 dark:border-medical-800">{currentQ.subject}</span><SourceBadge source={currentQ.source} />
